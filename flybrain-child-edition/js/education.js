(function () {
    ...
    window.EducationPanel = {
        ...
        _buildContent: function () {
            ...
            // Intro blurb
            html += '<p class="edu-text" style="margin-bottom:1rem;"><strong>This is a learning model, not a complete digital fly.</strong> It uses real fly-brain wiring data, then groups 139,255 neurons into 63 easier-to-watch pathways. That lets us ask a scientific question: how can a signal from the world lead to behaviour?</p>';
